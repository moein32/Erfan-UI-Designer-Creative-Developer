...
export const enTranslations: TranslationSchema = {
  ...
  hero: {
    ...
    shortName: 'ERFAN MOEIN',
    roleLine1: 'UI DESIGNER',
    roleAmpersand: '&',
    roleLine2: 'CREATIVE DEVELOPER',
    portraitAlt: 'Portrait of Erfan Moein, UI Designer and Creative Developer',
    location: 'QAZVIN, IR',
  ...
  experienceSection: {
    philosophy: {
      number: '02',
      tag: 'DESIGN PHILOSOPHY & ETHOS',
      headlineLine1: 'GREAT DESIGN TRANSCENDS',
      headlineLine2: 'EXPLANATION. IT BECOMES',
      headlineLine3: 'TACTILE AND INEVITABLE.',
      paragraph1:
        'Exceptional digital products require no onboarding manuals. When geometry, typographic cadence, and interactive physics align seamlessly with human mental models, software ceases to be an abstract utility—it becomes a natural extension of perception.',
      paragraph2:
        'I eliminate the historical divide between high visual art and rigorous frontend engineering. Every pixel is anchored in mathematical proportion, every motion state is tuned to 60fps spring physics, and every interface decision exists to clarify human action.',
      quoteAuthor: 'Erfan Moein — UI Designer & Creative Developer',
      pillars: [
        {
          number: '01',
          title: 'Radical Reduction',
          desc: 'Stripping away decorative noise until only structural logic, authentic beauty, and seamless utility remain on screen.',
        },
        {
          number: '02',
          title: 'Tactile Kinetic Physics',
          desc: 'Sculpting dynamic physical feedback that gives digital data weight, spatial depth, and an intuitive tactile feel.',
        },
        {
          number: '03',
          title: 'Direct Engineering',
          desc: 'Directly connecting Figma design tokens to clean TypeScript architectures without frame drops or translation loss.',
        },
      ],
    },
    approach: {
      number: '03',
      tag: 'CRAFT METHODOLOGY',
      title: 'Four-Phase Translation of Vision into Living Software',
      description: 'A disciplined engineering methodology that turns ambiguous product challenges into fluid, high-converting interfaces.',
      steps: [
        {
          number: '01',
          phase: 'DISCOVER',
          title: 'Root Problem Framing & Mental Modeling',
          desc: 'Unpacking cognitive user bottlenecks, diagramming information architectures, and stress-testing unstated assumptions.',
          bulletPoints: [
            'User mental model synthesis',
            'Complex workflow distillation',
            'Measurable product KPI mapping',
          ],
          hudTitle: 'Cognitive Architecture & Telemetry',
          hudMetrics: [
            { label: 'Friction Reduction', val: '68%' },
            { label: 'Flow Accuracy', val: '99.4%' },
          ],
        },
        {
          number: '02',
          phase: 'DEFINE',
          title: 'Token Systems & Typographic Cadence',
          desc: 'Formulating mathematical typography scales, Liquid Glass chromatic profiles, and semantic component trees.',
          bulletPoints: [
            '8px mathematical rhythmic spacing',
            'Bidirectional RTL / LTR token matrices',
            'WCAG AAA contrast & legibility guards',
          ],
          hudTitle: 'Token Matrix & Spatial Geometry',
          hudMetrics: [
            { label: 'Grid Density', val: '8px Grid' },
            { label: 'WCAG Contrast', val: 'AAA' },
          ],
        },
        {
          number: '03',
          phase: 'DESIGN',
          title: 'Tactile Surfaces & Material Craft',
          desc: 'Meticulously crafting views with directional lighting, 44px touch ergonomics, and refined liquid glass specular highlights.',
          bulletPoints: [
            'Liquid Glass materials with soft optical refraction',
            '44px mobile touch ergonomics & gesture flows',
            'High-fidelity interactive device prototyping',
          ],
          hudTitle: 'Tactile Prototyping & Studio',
          hudMetrics: [
            { label: 'Spatial Depth', val: 'Spatial 3D' },
            { label: 'Color Gamut', val: 'P3 Wide' },
          ],
        },
        {
          number: '04',
          phase: 'BUILD',
          title: 'Creative Code & 60fps Orchestration',
          desc: 'Translating designs into production TypeScript, GSAP ScrollTrigger timelines, and scalable full-stack codebases.',
          bulletPoints: [
            'Jank-free 60fps animations with GSAP ScrollTrigger',
            'Modular strict TypeScript component architecture',
            'Inertial smooth scrolling with Lenis engine',
          ],
          hudTitle: 'Creative Engineering & Performance',
          hudMetrics: [
            { label: 'Frame Rate', val: '60 FPS' },
            { label: 'Optimization', val: '100%' },
          ],
        },
      ],
    },
    skills: {
      number: '04',
      tag: 'TECHNICAL DEPTH & TOOLKIT',
      title: 'Mastery at the Intersection of Art & Code',
      description: 'Comprehensive, battle-tested depth across industry-standard design tools, frontend frameworks, and animation runtimes.',
      categories: [
        {
          id: 'design',
          name: 'Product Design & UI/UX',
          count: '01',
          description: 'Forging coherent visual identities, enterprise design systems, and user-centric interfaces with elite precision.',
          items: [
            { name: 'Figma Master / Variables', badge: 'Design Systems', level: 'Master' },
            { name: 'Design Tokens Architecture', badge: 'Token Systems', level: 'Advanced' },
            { name: 'Micro-Interactions & States', badge: 'Tactile Motion', level: 'Advanced' },
            { name: 'Persian / RTL Typography', badge: 'Bi-Directional', level: 'Native' },
            { name: 'Spatial & Liquid Materials', badge: 'Modern Shaders', level: 'Creative' },
          ],
        },
        {
          id: 'engineering',
          ...
          count: '02',
          description: 'Writing clean, declarative, production-ready code aligned with modern full-stack web standards.',
          items: [
            { name: 'React 19 & Next.js', badge: 'Core Runtime', level: 'Master' },
            { name: 'TypeScript Strict Mode', badge: 'Type Safety', level: 'Advanced' },
            { name: 'Tailwind CSS v4', badge: 'Responsive UI', level: 'Advanced' },
            { name: 'State Management & Context', badge: 'Data Architecture', level: 'Advanced' },
            { name: 'Web Performance & SEO', badge: 'Lighthouse 100', level: 'Optimized' },
          ],
        },
        {
          id: 'motion',
          name: 'Motion Choreography & Physics',
          count: '03',
          description: 'Crafting responsive transitions and kinetic pacing that reacts naturally to user gestures and scroll velocity.',
          items: [
            { name: 'GSAP 3 Core & Plugins', badge: 'Animation Engine', level: 'Master' },
            { name: 'ScrollTrigger Orchestration', badge: 'Scroll Sync', level: 'Advanced' },
            { name: 'Lenis Smooth Scrolling', badge: 'Inertial Scroll', level: 'Seamless' },
            { name: 'Spring & Inertia Physics', badge: 'Natural Physics', level: 'Fluid' },
            { name: 'Motion / Framer Engine', badge: 'Component Motion', level: 'Advanced' },
          ],
        },
        {
          id: 'accessibility',
          name: 'Systems Architecture & A11y',
          count: '04',
          description: 'Guaranteeing accessibility, robust modularity, and smooth responsiveness across all screen sizes.',
          items: [
            { name: 'Bilingual RTL/LTR Systems', badge: 'Dynamic Locale', level: 'Native' },
            { name: 'WCAG AAA Compliance', badge: 'Legibility Guard', level: 'Certified' },
            { name: 'Semantic HTML & ARIA', badge: 'A11y Hierarchy', level: 'Complete' },
            { name: 'Reduced Motion Handling', badge: 'Motion Preference', level: 'Supported' },
            { name: 'Cross-Device Responsiveness', badge: 'Fluid Scale', level: 'Rock-Solid' },
          ],
        },
      ],
    },
    cinematicContact: {
      number: '05',
      tag: 'FINALE & INQUIRY',
      headline1: "LET'S SHAPE",
      headline2: 'SOMETHING',
      headline3: 'EXCEPTIONAL.',
      subtext:
        'Available for select product design commissions, design system architecture, and creative frontend engineering for high-impact teams.',
      copyEmail: 'Copy Email Address',
      copied: 'Email Copied to Clipboard!',
      startInquiry: 'Submit Project Brief',
      directEmail: 'Send Direct Email',
      status: 'AVAILABLE FOR COMMISSIONS (Q2/Q3 2026)',
      timezone: 'Direct response within 24 hours guaranteed',
    },
  },
  contact: {
    tag: 'GET IN TOUCH',
    ...
    locationVal: 'Qazvin, Iran / Available for Worldwide Remote Commissions',
  ...
  quickInquiry: {
    badge: 'START A PROJECT WITH ERFAN MOEIN',
