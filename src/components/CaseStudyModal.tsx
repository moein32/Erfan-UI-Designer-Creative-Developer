...
export const CaseStudyModal: React.FC<CaseStudyModalProps> = ({
  ...
  return (
    ...
    >
      {/* Sticky Top Navigation Bar with Liquid Glass */}
      <header className="sticky top-0 z-50 liquid-glass border-b border-[#E5E7EB] px-6 md:px-12 py-4 flex items-center justify-between transition-all">
        {/* Breadcrumb Info */}
        <div className="flex items-center gap-3">
          ...
          <span className="hidden sm:inline-block text-[11px] font-mono text-[#71717A] px-2.5 py-0.5 rounded-full liquid-glass border border-[#E5E7EB]">
        ...
        <div className="hidden lg:flex items-center gap-1 liquid-glass border border-[#E5E7EB] rounded-full px-3 py-1 shadow-xs">
          {chapters.map((ch) => (
            <button
              key={ch.id}
      ...
      <main className="max-w-6xl mx-auto px-6 md:px-12 py-12 md:py-20 space-y-24">
        ...
        <section id="cs-overview" className="space-y-10">
          <div className="space-y-4">
            <div className="flex flex-wrap items-center gap-3">
              <span
                className="px-3 py-1 rounded-full text-xs font-mono font-bold uppercase tracking-wider border liquid-glass"
                style={{
                  borderColor: '#E5E7EB',
                  color: '#0A0A0A',
                }}
            ...
            <p className="text-xl sm:text-2xl md:text-3xl font-medium text-[#3F3F46] leading-snug max-w-3xl">
              {project.tagline}
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-6 sm:p-8 rounded-3xl bg-[#FFFFFF] border border-[#E5E7EB] shadow-xs">
        ...
        <section id="cs-challenge" className="space-y-8 pt-8 border-t border-[#E5E7EB]">
          <div className="flex items-center gap-3 text-xs font-mono tracking-widest text-[#71717A] uppercase">
            <span className="font-bold text-[#0A0A0A]">{formatNumber('02')}</span>
            <span>/</span>
            <span>{isRTL ? 'زمینه استراتژیک و معماری' : 'STRATEGIC CONTEXT'}</span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 rounded-3xl bg-[#FFFFFF] border border-[#E5E7EB] shadow-xs space-y-4">
        ...
        <section id="cs-simulation" className="space-y-8 pt-8 border-t border-[#E5E7EB]">
          <div className="flex items-center gap-3 text-xs font-mono tracking-widest text-[#71717A] uppercase">
            <span className="font-bold text-[#0A0A0A]">{formatNumber('03')}</span>
            <span>/</span>
        ...
        <section id="cs-tokens" className="space-y-8 pt-8 border-t border-[#E5E7EB]">
          <div className="flex items-center gap-3 text-xs font-mono tracking-widest text-[#71717A] uppercase">
            <span className="font-bold text-[#0A0A0A]">{formatNumber('04')}</span>
            <span>/</span>
            <span>{isRTL ? 'توکن‌های سیستم طراحی' : 'DESIGN SYSTEM TOKENS'}</span>
          </div>

          <div className="p-8 sm:p-10 rounded-3xl bg-[#FFFFFF] border border-[#E5E7EB] shadow-xs space-y-10">
            {/* Color Tokens */}
            <div className="space-y-4">
                ...
                {project.typography.map((typ) => (
                  ...
                  >
                    <div className="flex items-center justify-between text-xs font-mono text-[#71717A]">
                      <span>{typ.usage}</span>
                      <span className="font-bold text-[#0A0A0A]">{typ.font}</span>
                    </div>
                    <p className="text-lg font-medium text-[#0A0A0A] italic pt-1">
                      "{typ.sample}"
                    </p>
                  </div>
                ))}
        ...
        <section id="cs-impact" className="space-y-8 pt-8 border-t border-[#E5E7EB]">
          <div className="flex items-center gap-3 text-xs font-mono tracking-widest text-[#71717A] uppercase">
            <span className="font-bold text-[#0A0A0A]">{formatNumber('05')}</span>
            <span>/</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {project.metrics.map((metric) => (
              <div
                key={metric.label}
                className="p-6 sm:p-8 rounded-3xl bg-[#FFFFFF] border border-[#E5E7EB] shadow-xs text-start"
              >
                <div
